<div class="container px-5 my-5">
    ...
    <form action="?=periksa_proses" method="post" class="row g-3" data-sb-form-api-token="API_TOKEN">
        <div class="col-md-6">
            <label class="form-label" for="nama">Nama</label>
            <input class="form-control" id="nama" type="text" placeholder="Nama" name="txtNama" data-sb-validations="required" />
        ...
        <div class="col-md-4">
            ...
            <input class="form-control" id="usia" type="text" placeholder="Usia" name="txtUsia" data-sb-validations="required" />
            <div class="invalid-feedback" data-sb-feedback="usia:required">Usia is required.</div>
        </div>
        <div class="col-md-4">
            <label class="form-label" for="beratBadan">Berat Badan</label>
            <div class="input-group">
                <input class="form-control" id="beratBadan" type="text" placeholder="Berat Badan" name="txtBB" data-sb-validations="required" />
                <span class="input-group-text">Kg</span>
                <div class="invalid-feedback" data-sb-feedback="beratBadan:required">Berat Badan is required.</div>
            </div>
        </div>
        <div class="col-md-4">
            <label class="form-label" for="tinggiBadan">Tinggi Badan</label>
            <div class="input-group">
                <input class="form-control" id="tinggiBadan" type="text" placeholder="Tinggi Badan" name="txtTB" data-sb-validations="required" />
                <span class="input-group-text">Cm</span>
                <div class="invalid-feedback" data-sb-feedback="tinggiBadan:required">Tinggi Badan is required.</div>
            </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-8">
            ...
            <select class="form-select" id="stress" name="slSts" aria-label="Stress">
                ...
                <option value="2.1t">Luka bakar sangat berat</option>
            </select>
        </div>
